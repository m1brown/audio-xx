...
const BRAND_PROFILES: BrandProfile[] = [
  ...
  },
  {
    ...
    tendencies: 'Goldmund electronics are described as fast, transparent, articulate, and rigorously controlled. Tonal character is lean and precise — speed and resolution dominate over warmth or harmonic density. The SRDA DAC follows the same lineage with clean, time-domain-coherent presentation rather than tonal saturation.',
    systemContext: 'Goldmund sources and amplifiers work best with loudspeakers that provide their own tonal body — full-range designs, larger panels, or warm-leaning speakers can balance the leanness. In systems already biased toward precision, the cumulative character may read as thin.',
    designPhilosophy: 'Time-domain precision and Mechanical Grounding — structural vibration treated as primary distortion.',
    sonicTendency: 'Fast, lean, articulate, rigorously controlled.',
    typicalTradeoff: 'Speed and precision over warmth and harmonic density.',
