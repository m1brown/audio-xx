...
export const AMPLIFIER_PRODUCTS: Product[] = [
...

  {
    ...
    sourceReferences: [
      { source: 'Stereophile', note: 'Review praising warmth, lushness, and seductive musicality from solid-state Class A.', url: 'https://www.stereophile.com/content/grandinote-shinai-integrated-amplifier' },
...

  {
    ...
    traits: {
      ...
      speed: 1.0, dynamics: 0.85, flow: 0.7,
      spatial_precision: 0.95, composure: 0.9, texture: 0.85,
      fatigue_risk: 0.1, glare_risk: 0.05,
      elasticity: 0.5,
    },
    description: 'German precision monoblocks with ultra-wide bandwidth and zero global feedback. Ivo Linnenberg\'s designs prioritise speed, transparency, and phase coherence. Extremely resolving without crossing into aggression. The Liszt partners particularly well with widebander and full-range speakers. Reviewed extensively by 6moons.',
    retailer_links: [
...

  {
    ...
    fatigueAssessment: {
      risk: 'very_low',
      notes: 'Organic, warm presentation despite class D topology. GaN eliminates the harshness associated with conventional class D.',
    },
    tendencyProfile: {
      basis: 'review_consensus',
      confidence: 'high',
    ...
    traits: {
      clarity: 0.7, warmth: 0.7, tonal_density: 0.8,
      speed: 0.85, dynamics: 0.75, flow: 0.9,
      spatial_precision: 0.75, composure: 0.7, texture: 0.8,
      fatigue_risk: 0.0, glare_risk: 0.0,
      elasticity: 0.8,
    },
    description: 'GaN class D that sounds like class A. Alberto Guerra\'s designs break the class D stereotype — warm, organic midrange with tube-like richness and solid-state speed. GaN transistors switch fast enough to eliminate the timing artifacts that make conventional class D sound mechanical. Pioneer in making class D musically engaging. Reviewed extensively by 6moons.',
    retailer_links: [
    ...
    tendencies: {
      confidence: 'high',
      character: [
        { domain: 'tonality', tendency: 'warm, organic, tube-like midrange richness — breaks the class D stereotype', basis: 'review_consensus' },
        { domain: 'dynamics', tendency: 'musically elastic — GaN speed with organic flow rather than mechanical precision', basis: 'review_consensus' },
        { domain: 'timing', tendency: 'natural musical phrasing — class A-like flow from a class D topology', basis: 'review_consensus' },
      ],
      interactions: [
        { condition: 'paired with neutral or detailed speakers', effect: 'the warmth and organicness add body without muddying detail', valence: 'positive', basis: 'review_consensus' },
        { condition: 'in already-warm systems', effect: 'may compound warmth — the organic character could push toward lush rather than precise', valence: 'caution', basis: 'editorial_inference' },
      ],
      tradeoffs: [
        { gains: 'organic musicality, warmth, and engagement from a class D topology — plus efficiency and cool running', cost: 'the last degree of analytical precision and control that reference class AB designs provide', relative_to: 'precision class AB monoblocks (Soulution, Goldmund)', basis: 'review_consensus' },
      ],
    },
    sourceReferences: [
      { source: '6moons', note: 'Alberto Guerra\'s AGD Vivace and Audion extensively reviewed. Praised for redefining class D musicality.' },
    ],
    notes: 'Alberto Guerra is a pioneer in applying GaN transistors to class D amplification. His designs use proprietary GaN output stages that eliminate the switching artifacts of conventional class D.',
    philosophy: 'warm',
    marketType: 'traditional',
  },
...

  {
    ...
    price: 3300,
    category: 'amplifier',
    architecture: 'THX AAA class AB/H, ultra-low distortion, pro-audio heritage',
    subcategory: 'power-amp',
    priceTier: 'upper-mid',
    brandScale: 'specialist',
    region: 'north-america',
    ...
    fatigueAssessment: {
      risk: 'moderate',
      notes: 'Extreme transparency can be fatiguing with poorly recorded material or in analytical systems. With good recordings and complementary speakers, fatigue is low.',
    },
    tendencyProfile: {
      basis: 'review_consensus',
      confidence: 'high',
    ...
    traits: {
      clarity: 1.0, warmth: 0.0, tonal_density: 0.3,
      speed: 0.85, dynamics: 0.75, flow: 0.5,
      spatial_precision: 0.9, composure: 0.9, texture: 0.6,
      fatigue_risk: 0.3, glare_risk: 0.2,
      elasticity: 0.3,
    },
    description: 'The measuring champion — lowest noise and distortion of any consumer amplifier. Pro-audio DNA means it is designed to add nothing to the signal. Clinically transparent. Either a revelation or too clean depending on your priorities. Excels as a headphone amplifier for planar magnetics and as a speaker amp for difficult loads. Polarising — some love the purity, others find it soulless.',
    retailer_links: [
    ...
    tendencies: {
      confidence: 'high',
      character: [
        { domain: 'tonality', tendency: 'vanishingly neutral — adds nothing. The most transparent consumer amplifier by measurement', basis: 'review_consensus' },
        { domain: 'dynamics', tendency: 'clean and controlled — authority without warmth or bloom', basis: 'review_consensus' },
        { domain: 'spatial', tendency: 'precise imaging — the low noise floor reveals spatial cues in the recording', basis: 'review_consensus' },
      ],
      interactions: [
        { condition: 'paired with warm or full-bodied speakers', effect: 'excellent complementary balance — the speakers define character, the amp preserves it', valence: 'positive', basis: 'review_consensus' },
        { condition: 'paired with Raal-Requisite ribbon headphones', effect: 'popular combination — the AHB2 has the current capability and transparency these headphones demand', valence: 'positive', basis: 'listener_consensus' },
        { condition: 'in already-lean or analytical systems', effect: 'may sound sterile or clinical — no warmth to compensate', valence: 'caution', basis: 'review_consensus' },
      ],
      tradeoffs: [
        { gains: 'extreme transparency, vanishingly low distortion, and reference-grade neutrality', cost: 'tonal warmth, harmonic richness, and musical engagement for listeners who prefer coloration', relative_to: 'tube amplifiers and warm solid-state designs', basis: 'review_consensus' },
      ],
    },
    sourceReferences: [
    ...
    notes: 'Benchmark\'s pro-audio heritage means the AHB2 prioritises signal accuracy over sonic character. It is the amplifier equivalent of a studio monitor — designed to reveal, not embellish.',
    philosophy: 'neutral',
    marketType: 'traditional',
  },
];
