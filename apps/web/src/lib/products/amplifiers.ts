...
export const AMPLIFIER_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    sourceReferences: [
      ...
      { source: 'Hifi News', note: 'Noted as excellent Class D integrated at mid-fi pricing.' },
    ],
  ...
  },
  {
    ...
    sourceReferences: [
      { source: 'Stereophile', note: 'Praised for Swiss transparency and precision imaging excellence.' },
