...
export const HEADPHONE_PRODUCTS: HeadphoneProduct[] = [
  ...
  // asserting design intent.
  {
    ...
    traits: {
      clarity: 0.45, warmth: 0.6, tonal_density: 0.45,
      speed: 0.45, dynamics: 0.4, flow: 0.6,
      spatial_precision: 0.35, composure: 0.45, texture: 0.4,
      fatigue_risk: 0.12, openness: 0.35,
    },
    description: 'The smallest shell in the catalogue, which is the reason to choose it — it fits ears other IEMs do not. Tuning is mild and unfussy; scale and separation are limited by the driver size, not hidden by it.',
    retailer_links: [],
    headphoneMeta: {
  ...
  },
  {
    ...
    traits: {
      clarity: 0.6, warmth: 0.55, tonal_density: 0.55,
      speed: 0.55, dynamics: 0.55, flow: 0.58,
      spatial_precision: 0.5, composure: 0.6, texture: 0.5,
      fatigue_risk: 0.15, openness: 0.45,
    },
    description: 'Balanced across the range with no obvious deficit at the price — bass has body without dominating, treble is present without bite. The safe answer when no particular preference has been stated.',
    retailer_links: [],
    headphoneMeta: {
      formFactor: 'iem', wireless: false, anc: false,
      isolation: 'high', portableUse: true,
